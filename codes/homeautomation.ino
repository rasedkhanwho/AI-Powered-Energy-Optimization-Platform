...
// Enter the IP address of the computer/server running the backend
const char* backendIP = "YOUR_BACKEND_IP";

// Enter the User ID generated by the web application
...
// NOTE:
// Replace YOUR_BACKEND_IP and YOUR_USER_ID below
// with your actual backend IP address and User ID.

// Sync endpoint for this user
const char* syncUrl =
  "http://YOUR_BACKEND_IP:8000/api/appliances/esp32-sync/"
  "YOUR_USER_ID";

// Base endpoint used for appliance toggle requests
const char* toggleBaseUrl =
  "http://YOUR_BACKEND_IP:8000/api/appliances/";
